...
export async function getLivePositions(address: string): Promise<WalletPositions> {
  ...
  try {
    ...
    const mnt = parseFloat(ethers.formatEther(mntRaw));

    // Fetch all token balances in parallel
    const [meth, cmeth, usdt, usdc] = await Promise.all([
      getTokenBalance(provider, TOKEN_ADDRESSES['0xcda86a272531e8640cd7f1a92c01839911b90bb0'], 18),
      getTokenBalance(provider, TOKEN_ADDRESSES['0xe6829d9a7ee3040e1276fa75293bde931859e8fa'], 18),
      getTokenBalance(provider, TOKEN_ADDRESSES['0x201eba5cc46d216ce6dc03f6a759e8e766e956ae'], 6),
      getTokenBalance(provider, TOKEN_ADDRESSES['0x09bc4e0d864854c6afb6eb9a9cdf58ac190d0df9'], 6),
    ]);
